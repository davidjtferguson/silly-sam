    ...
    },
    {
      ...
      objects = {
        ...
        },
        {
          ...
          properties = {
            ["static"] = true,
            ["texturePath"] = "assets/art/gameobjects/housetextures_006.png"
          }
        },
        {
          id = 160,
          ...
          properties = {
            ["static"] = true,
            ["texturePath"] = "assets/art/gameobjects/housetextures_001.png"
          }
        },
        {
          id = 161,
          ...
          properties = {
            ["static"] = true,
            ["texturePath"] = "assets/art/gameobjects/housetextures_003.png"
          }
        },
        {
          id = 162,
